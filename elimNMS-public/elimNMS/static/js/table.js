...
export class Table {
  ...
  setPagination() {
    const button = `
      <ul class="pagination" style="margin: 0px;">
        <li>
          <a
            onclick="elimNMS.table.togglePaginationDisplay('${this.id}')"
  ...
  bulkFilteringButton() {
    ...
    return `
      <button
        class="btn btn-info"
        onclick="elimNMS.${showPanelFunction}"
  ...
  createNewButton() {
    const onClick = this.relation
      ? `elimNMS.base.showAddInstancePanel(
          '${this.id}', '${this.type}', ${this.relationString}
        )`
      : this.type == "service"
      ? `elimNMS.automation.openServicePanel()`
      : this.type == "device" || this.type == "link"
      ? `elimNMS.inventory.openObjectPanel('${this.type}')`
      : `elimNMS.base.showInstancePanel('${this.type}')`;
    return `
      <button
  ...
  exportTableButton() {
    return `
      <button
        class="btn btn-primary"
        onclick="elimNMS.table.exportTable('${this.id}')"
  ...
  clearSearchButton() {
    return `
      <button
        class="btn btn-info"
        onclick="elimNMS.table.clearSearch('${this.id}', true)"
  ...
  refreshTableButton() {
    return `
      <button
        class="btn btn-info"
        onclick="elimNMS.table.refreshTable('${this.id}', true)"
  ...
  copyTableButton() {
    return `
      <button
        class="btn btn-info"
        onclick="elimNMS.table.copySelectionToClipboard('${this.id}')"
  ...
  bulkDeletionButton() {
    const onClick = this.relation
      ? `elimNMS.table.bulkRemoval('${this.id}', '${this.model}', ${this.relationString})`
      : `elimNMS.table.showBulkDeletionPanel('${this.id}', '${this.model}')`;
    return `
      <button
  ...
  deleteInstanceButton(row) {
    const onClick = this.relation
      ? `elimNMS.base.removeInstance(
          '${this.id}', ${row.instance}, ${this.relationString}
        )`
      : `elimNMS.base.showDeletionPanel(${row.instance}, '${this.id}')`;
    return `
      <li>
...
tables.device = class DeviceTable extends Table {
  addRow(kwargs) {
    ...
    for (const model of ["service", "task", "pool"]) {
      ...
      row[`${model}s`] = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
  ...
  get controls() {
    return [
      ...
      ` <button
        ...
        onclick="elimNMS.automation.showRunServicePanel(
    ...
    return `
      <ul class="pagination pagination-lg" style="margin: 0px; width: 270px">
        <li>
          ...
          onclick="elimNMS.inventory.showDeviceData(${row.instance})"
        ...
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.inventory.showDeviceResultsPanel(${row.instance})"
        ...
        <li>
          ...
          onclick="elimNMS.inventory.showConnectionPanel(${row.instance})"
        ...
        <li>
          ...
          onclick="elimNMS.base.showInstancePanel('${row.type}', '${
      row.id
    }')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
        ...
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('${row.type}', '${row.id}', 'duplicate')"
        ...
        <li>
          ...
          onclick="elimNMS.automation.showRunServicePanel({instance: ${row.instance}})"
...
tables.network = class NetworkTable extends Table {
  addRow(kwargs) {
    ...
    row.links = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
  ...
  buttons(row) {
    return `
      <ul class="pagination pagination-lg" style="margin: 0px">
        ...
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.inventory.showGitHistory(${row.instance})"
        ...
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('${row.type}', '${row.id}')"
...
tables.link = class LinkTable extends Table {
  addRow(properties) {
    ...
    row.pools = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
...
tables.pool = class PoolTable extends Table {
  ...
  get controls() {
    return [
      ...
      ` <button
        class="btn btn-primary"
        onclick="elimNMS.inventory.updatePools()"
  ...
  buttons(row) {
    return `
      <ul class="pagination pagination-lg" style="margin: 0px; width: 200px">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.inventory.updatePools('${row.id}')"
          data-tooltip="Update"><span class="glyphicon glyphicon-refresh">
          </span></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('pool', '${row.id}')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('pool', '${row.id}', 'duplicate')"
          data-tooltip="Duplicate"
            ><span class="glyphicon glyphicon-duplicate"></span
          ></button>
        </li>
...
tables.service = class ServiceTable extends Table {
  addRow(kwargs) {
    ...
    row["runs"] = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
  ...
  get controls() {
    return [
      ...
      <button
        class="btn btn-info"
        onclick="elimNMS.table.refreshTable('service', true)"
        data-tooltip="Refresh"
        type="button"
      >
        <span class="glyphicon glyphicon-refresh"></span>
      ...
      `<button
        class="btn btn-primary"
        onclick="elimNMS.automation.showImportServicesPanel()"
      ...
      <button
        class="btn btn-primary"
        onclick="elimNMS.table.showBulkServiceExportPanel('${this.id}')"
  ...
  buttons(row) {
    ...
    return `
      <ul class="pagination pagination-lg" style="margin: 0px; width: 310px">
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.automation.showRuntimePanel('logs', ${row.instance})"
          data-tooltip="Logs">
        ...
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.automation.showRuntimePanel('results', ${row.instance}
        ...
        <li>
          <button type="button" class="btn btn-sm btn-success"
          onclick="elimNMS.automation.runService({id: '${row.id}',
...
tables.run = class RunTable extends Table {
  addRow(kwargs) {
    ...
    row[`services`] = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
      'service', ${row.instance}, {parent: '${this.id}', from: 'runs',
      to: 'services'})">Services</a></b>`;
    if (row.server_properties) {
      row.server_link = `<b><a href="#" onclick="elimNMS.base.showInstancePanel(
        'server', '${row.server_properties.id}')">${row.server_properties.name}
        </a></b>`;
    }
    if (row.worker_properties) {
      row.worker_link = `<b><a href="#" onclick="elimNMS.base.showInstancePanel(
  ...
  get controls() {
    return [
      ...
      ` <button
        class="btn btn-info"
        onclick="elimNMS.automation.displayCalendar('run')"
  ...
  buttons(row) {
    return [
      `<ul class="pagination pagination-lg" style="margin: 0px; width: 150px">
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.automation.showRuntimePanel('logs', ${row.service},
          '${row.runtime}')" data-tooltip="Logs">
          <span class="glyphicon glyphicon-list"></span></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.automation.showRuntimePanel('report', ${row.service},
          '${row.runtime}')" data-tooltip="Report">
          <span class="glyphicon glyphicon-modal-window"></span></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.automation.showRuntimePanel('results', ${row.service},
          '${row.runtime}')" data-tooltip="Results">
          <span class="glyphicon glyphicon-list-alt"></span></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-danger"
          onclick="elimNMS.automation.stopRun('${row.runtime}')"
...
tables.result = class ResultTable extends Table {
  ...
  get controls() {
    ...
    return [
      ...
      `<button
        class="btn btn-info"
        onclick="elimNMS.automation.displayDiff('${this.type}', ${id})"
  ...
  buttons(row) {
    ...
    <ul class="pagination pagination-lg" style="margin: 0px; width: 90px">
      <li>
        <button type="button" class="btn btn-sm btn-info"
        onclick="elimNMS.automation.showResult('${row.id}')"
      ...
      <li>
        <button
          ...
          onclick="elimNMS.automation.copyClipboard(
...
tables.task = class TaskTable extends Table {
  ...
  get controls() {
    return [
      ...
      ` <button
        class="btn btn-info"
        onclick="elimNMS.automation.displayCalendar('task')"
        data-tooltip="Calendar"
        type="button"
      >
        <span class="glyphicon glyphicon-calendar"></span>
      ...
      ` <button
        type="button"
        class="btn btn-success"
        onclick="elimNMS.automation.schedulerAction('resume')"
      ...
      <button
        type="button"
        class="btn btn-danger"
        onclick="elimNMS.automation.schedulerAction('pause')"
  ...
  buttons(row) {
    ...
    return [
      `<ul class="pagination pagination-lg" style="margin: 0px; width: 200px">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('task', '${row.id}')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('task', '${row.id}', 'duplicate')"
          data-tooltip="Duplicate">
          <span class="glyphicon glyphicon-duplicate"></span></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-success ${state[0]}" ${state[0]}
          onclick="elimNMS.automation.resumeTask('${row.id}')" data-tooltip="Play"
            ><span class="glyphicon glyphicon-play"></span
          ></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-danger ${state[1]}" ${state[1]}
          onclick="elimNMS.automation.pauseTask('${row.id}')" data-tooltip="Pause"
            ><span class="glyphicon glyphicon-pause"></span
          ></button>
        </li>
        ${this.deleteInstanceButton(row)}
...
tables.group = class GroupTable extends Table {
  addRow(kwargs) {
    let row = super.addRow(kwargs);
    row.users = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
  ...
  get controls() {
    return [
      ...
      ` <button
        class="btn btn-primary"
        onclick="elimNMS.administration.updateDeviceRbac()"
  ...
  buttons(row) {
    return [
      ...
      <ul class="pagination pagination-lg" style="margin: 0px;">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('group', '${
            row.id
          }')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
        ...
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('group', '${row.id}', 'duplicate')"
          data-tooltip="Duplicate"
            ><span class="glyphicon glyphicon-duplicate"></span
          ></button>
        </li>
...
tables.user = class UserTable extends Table {
  addRow(kwargs) {
    let row = super.addRow(kwargs);
    row.groups = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
  ...
  buttons(row) {
    return [
      ...
      <ul class="pagination pagination-lg" style="margin: 0px;">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('user', '${row.id}')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('user', '${row.id}', 'duplicate')"
          data-tooltip="Duplicate"
            ><span class="glyphicon glyphicon-duplicate"></span
          ></button>
        </li>
  ...
  buttons(row) {
    return [
      ...
      <ul class="pagination pagination-lg" style="margin: 0px;">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('credential', '${row.id}')"
          data-tooltip="Edit"><span class="glyphicon glyphicon-edit"></span></button>
        </li>
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('credential', '${row.id}', 'duplicate')"
          data-tooltip="Duplicate"
            ><span class="glyphicon glyphicon-duplicate"></span
          ></button>
        </li>
...
tables.server = class ServerTable extends Table {
  addRow(kwargs) {
    ...
    row.runs = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
      ...
      Runs</a></b>`;
    row.workers = `<b><a href="#" onclick="elimNMS.table.displayRelationTable(
  ...
  buttons(row) {
    return [
      ...
      <ul class="pagination pagination-lg" style="margin: 0px;">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('server', '${
            row.id
          }')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
        ...
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('server', '${row.id}', 'duplicate')"
          data-tooltip="Duplicate"
            ><span class="glyphicon glyphicon-duplicate"></span
          ></button>
        </li>
  ...
  buttons(row) {
    return [
      ...
      <ul class="pagination pagination-lg" style="margin: 0px;">
        <li>
          <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.inventory.showSessionLog(${row.id})" data-tooltip="Session Log"
            ><span class="glyphicon glyphicon-list"></span
          ></button>
        </li>
      </ul>`,
...
tables.file = class FileTable extends Table {
  addRow(properties) {
    let row = super.addRow(properties);
    if (row.type == "folder") {
      row.filename = `<a href="#" onclick="elimNMS.administration.enterFolder
        ({ folder: '${row.filename}'})">
  ...
  get controls() {
    ...
    return [
      ...
      <a
        ...
        onclick="elimNMS.administration.enterFolder({parent: true})"
        type="button"
      >
      ...
      <button
        ...
        onclick="elimNMS.base.showInstancePanel('folder')"
      ...
      ` <button
        class="btn btn-primary parent-filtering"
        onclick="elimNMS.administration.showFileUploadPanel()"
      ...
      ` <button
        class="btn btn-primary"
        onclick="elimNMS.administration.scanFolder()"
  ...
  copyClipboardButton(row) {
    return `
      <li>
        <button type="button" class="btn btn-sm btn-info"
          onclick="elimNMS.base.copyToClipboard({text: '${filePath}${row.path}' })"
  ...
  editButton(row) {
    return `
      <li>
        <button type="button" class="btn btn-sm btn-primary"
        onclick="elimNMS.base.showInstancePanel(
    ...
    if (row.type == "folder") {
      return [
        ...
        <ul class="pagination pagination-lg" style="margin: 0px;">
          ...
          <button type="button"
            class="btn btn-sm btn-primary"
            onclick="elimNMS.administration.showFileUploadPanel('${row.path}')"
      ...
      return [
        ...
        <ul class="pagination pagination-lg" style="margin: 0px;">
          ...
          <li>
            <button type="button" class="btn btn-sm btn-primary"
            onclick="elimNMS.administration.editFile(
  ...
  buttons(row) {
    return [
      ...
      <ul class="pagination pagination-lg" style="margin: 0px;">
        <li>
          <button type="button" class="btn btn-sm btn-primary"
          onclick="elimNMS.base.showInstancePanel('worker', '${
            row.id
          }')" data-tooltip="Edit"
            ><span class="glyphicon glyphicon-edit"></span
          ></button>
...
export const clearSearch = function(tableId, notification) {
  ...
  if (notification) notify("검색 매개변수가 삭제되었습니다.", "success", 5);
};
...
export const refreshTable = function(tableId, notification, updateParent, firstPage) {
  ...
  if (notification) notify("테이블이 새로고침되었습니다.", "success", 5);
};
...
function bulkDeletion(tableId, model) {
  call({
    ...
    callback: function(number) {
      ...
      notify(`${number}개 항목이 삭제되었습니다.`, "success", 5, true);
    },
  });
}
...
function bulkEdit(formId, model, tableId) {
  call({
    ...
    callback: function(number) {
      ...
      notify(`${number}개 항목이 수정되었습니다.`, "success", 5, true);
    },
  });
}
