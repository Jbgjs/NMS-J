...
export function displayDiff(type, instanceId) {
  ...
  if (!v1 || !v2) {
    notify("먼저 비교할 두 버전을 선택하세요.", "error", 5);
  } else if (v1 == v2) {
    notify("서로 다른 두 버전을 선택해야 합니다.", "error", 5);
  } else {
      ...
      <div class="input-group" style="width: 500px">
        ...
        <span class="input-group-btn">
          <button class="btn btn-default"
            onclick="elimNMS.base.copyToClipboard({text: 'link-${id}', isId: true})"
            type="button"
          >
      ...
      <div class="input-group" style="width:100%">
        ...
        <span class="input-group-btn">
          <button class="btn btn-default pull-right"
            onclick="elimNMS.base.copyToClipboard({text: 'result-path-${id}', isId: true})"
            type="button"
          >
            <span class="glyphicon glyphicon-copy"></span>
          </button>
        ...
        <div class="modal-body">
          ...
          >
            ...
            <div style="width: 30px; float: left; margin-left: 15px;">
              <button
                class="btn btn-default pull-right"
                onclick="elimNMS.automation.downloadRun('${panelType}', ${service.id})"
        ...
        <div class="modal-body">
          ...
          <div style="width: 30px; float: left; margin-left: 15px;">
            <button
              ...
              onclick="elimNMS.automation.showRuntimePanel(
...
function pauseTask(id) {
  call({
    ...
    callback: function() {
      $(`#pause-resume-${id}`)
        .attr("onclick", `elimNMS.automation.resumeTask('${id}')`)
        .text("Resume");
      refreshTable("task");
...
function resumeTask(id) {
  call({
    ...
    callback: function() {
      $(`#pause-resume-${id}`)
        .attr("onclick", `elimNMS.automation.pauseTask('${id}')`)
        .text("Pause");
      refreshTable("task");
