...
class FormFactory:
        ...
        for model in ("device", "link", "user", "service"):
            ...
            type(
                ...
                (BaseForm,),
                {
                    ...
                    "action": "elimNMS.base.addInstancesToRelation",
    ...
    def generate_service_forms(self):
        for file in (vs.path / "elimNMS" / "forms").glob("**/*.py"):
...
class AddToNetworkForm(BaseForm):
    action = "elimNMS.networkBuilder.addObjectsToNetwork"
...
class DatabaseDeletionForm(BaseForm):
    action = "elimNMS.administration.databaseDeletion"
...
class ExcelExportForm(BaseForm):
    action = "elimNMS.inventory.exportTopology"
...
class ImportServices(BaseForm):
    action = "elimNMS.automation.importServices"
...
class RestartWorkflowForm(BaseForm):
    action = "elimNMS.workflowBuilder.restartWorkflow"
...
class ResultLogDeletionForm(BaseForm):
    action = "elimNMS.administration.resultLogDeletion"
...
class RunServiceForm(BaseForm):
    action = "elimNMS.automation.runServicesOnTargets"
...
class UserProfileForm(BaseForm):
    ...
    action = "elimNMS.administration.saveProfile"
    name = StringField("Name")
    email = StringField("Email")
...
class WorkflowLabelForm(BaseForm):
    ...
    action = "elimNMS.builder.createLabel"
