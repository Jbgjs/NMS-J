...
# how to implement their own custom services to elimNMS.

# To create a new service in elimNMS, you need to implement:
...
from elimNMS.forms import ServiceForm
...
from elimNMS.models.automation import Service
